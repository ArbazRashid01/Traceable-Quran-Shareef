...
.bt{font-size:8.5px;font-style:italic;color:#a07830;margin-bottom:4px;letter-spacing:1.5px}
.ba{font-family:'Amiri',serif;font-size:34px;direction:rtl;
    color:rgba(0,0,0,.12);line-height:1.6}
"""
...
/* LEFT — verse meaning, vertically centred, aligns with its Arabic rows */
.vm{width:24%;min-width:24%;border-right:1px solid #d4b870;
    background:#f6ead6;padding:8px 7px;
    display:flex;flex-direction:column;justify-content:center;align-items:center;
    gap:5px}
.vn{font-family:'Amiri',serif;font-size:11px;font-weight:700;color:#8b6c14;
    border:1px solid #c9a84c;border-radius:50%;width:18px;height:18px;
...
.as{font-family:'Amiri',serif;font-size:17px;color:#c9a84c;
